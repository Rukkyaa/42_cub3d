...
#    Updated: 2023/04/29 16:40:49 by theo             ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
# GAME #
GAME_SRC_BONUS = $(addprefix bonus/game/, $(addsuffix .c, utils time player_move player_rotate player_collisions entity_collision weapon))
