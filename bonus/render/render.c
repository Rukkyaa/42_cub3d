...
/*   Updated: 2023/04/07 11:57:34 by axlamber         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	render_life_bar(t_game *game)
{
	...
	end.x = start.x + (game->hud.life_bar.width * game->player.hp
			/ game->player.max_hp);
...
void	render_ui(t_game *game)
{
	...
	put_img_to_img(game->hud.weapon_anim.current_img, &game->fps_img, RES_X
		/ 2 - game->hud.weapon_anim.current_img->width / 2, RES_Y
		- game->hud.weapon_anim.current_img->heigth);
...
void	render_map(t_game *game)
{
	...
	// load_map(game);
	sample_img_to_img(&game->minimap, &game->debug_img, game->player.pos.x
		- 122, game->player.pos.y - 122);
