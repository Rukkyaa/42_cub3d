...
/*   Updated: 2023/02/17 15:55:47 by teliet           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	t_vector point;
	point.x = (int) (game->player.pos.x + game->player.direction.x * 50.0f);
	point.y = (int) (game->player.pos.y + game->player.direction.y * 50.0f);
...
void	move(t_game *game, char direction)
{
	...
	draw_filled_circle(game, game->player.pos, 10, GREEN_PIXEL);
	...
	if (direction == 'N')
		...
		game->player.pos.x += 2;
	draw_filled_circle(game, game->player.pos, 10, RED_PIXEL);
